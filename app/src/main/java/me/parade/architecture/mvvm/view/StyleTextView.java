 ...
 * @author : parade
 * date : 2020/8/3
 * description : 自定义TextView的样式，四个边角，边框，背景颜色
 */
...
//        int solid = a.getColor(R.styleable.customTextView_textSolidColor, Color.TRANSPARENT);
        int strokeColor = a.getColor(R.styleable.StyleTextView_textStrokeColor, Color.TRANSPARENT);
        radius = a.getDimensionPixelSize(R.styleable.StyleTextView_textRadius, 0);
        int leftTopRadius = a.getDimensionPixelSize(R.styleable.StyleTextView_textLeftTopRadius, 0);
        int leftBottomRadius = a.getDimensionPixelSize(R.styleable.StyleTextView_textLeftBottomRadius, 0);
        int rightTopRadius = a.getDimensionPixelSize(R.styleable.StyleTextView_textRightTopRadius, 0);
        int rightBottomRadius = a.getDimensionPixelSize(R.styleable.StyleTextView_textRightBottomRadius, 0);
        strokeWidth = a.getDimensionPixelSize(R.styleable.StyleTextView_textStrokeWidth, 0);
        int normalTextColor = a.getColor(R.styleable.StyleTextView_textNormalTextColor, Color.TRANSPARENT);
        int selectedTextColor = a.getColor(R.styleable.StyleTextView_textSelectedTextColor, Color.TRANSPARENT);
        int normalSolidColor = a.getColor(R.styleable.StyleTextView_textNormalSolidColor, Color.TRANSPARENT);
        int pressedSolidColor = a.getColor(R.styleable.StyleTextView_textPressedSolidColor, Color.TRANSPARENT);
        boolean isSelected = a.getBoolean(R.styleable.StyleTextView_textIsSelected,false);
        boolean noLeftStroke = a.getBoolean(R.styleable.StyleTextView_textNoLeftStroke,false);
        boolean noRightStroke = a.getBoolean(R.styleable.StyleTextView_textNoRightStroke,false);
        boolean noTopStroke = a.getBoolean(R.styleable.StyleTextView_textNoTopStroke,false);
        boolean noBottomStroke = a.getBoolean(R.styleable.StyleTextView_textNoBottomStroke,false);
        Drawable textDrawable = a.getDrawable(R.styleable.StyleTextView_textDrawable);
    ...
    public void setTextDrawable(int drawableId) {
        if (drawableId != 0) {
            Drawable textDrawable = ResourcesCompat.getDrawable(getResources(),drawableId,null);
            BitmapDrawable bd = (BitmapDrawable) textDrawable;
            ImageSpan imageSpan = new ImageSpan(getContext(), Objects.requireNonNull(bd).getBitmap());
     ...
     * 设置填充颜色
     *
     * @param normalSolidColor   正常状态颜色id
     */
    public void setSolidColor(int normalSolidColor) {
